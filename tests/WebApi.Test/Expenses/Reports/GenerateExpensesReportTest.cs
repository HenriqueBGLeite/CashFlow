...
public class GenerateExpensesReportTest : CashFlowClassFixture
{
    ...
    {
        var result = await DoGet(baseUrl: $"{BaseUrl}/pdf?month={_expenseDate:yyyy-MM}", token: _adminToken);
    ...
    {
        var result = await DoGet(baseUrl: $"{BaseUrl}/excel?month={_expenseDate:yyyy-MM}", token: _adminToken);
    ...
    {
        var result = await DoGet(baseUrl: $"{BaseUrl}/pdf?month={_expenseDate:yyyy-MM}", token: _teamMemberToken);
    ...
    {
        var result = await DoGet(baseUrl: $"{BaseUrl}/excel?month={_expenseDate:yyyy-MM}", token: _teamMemberToken);
